...
if __name__ == "__main__":
    ...
    #
    # train.train_and_evaluate_kd(model=cnn2_1, teacher_model=resnet34, optimizer=optimizer_cnn2_1,
    #                             train_dataloader=train_dataloader, val_dataloader=valid_dataloader,
    ...
    # tea_encoder: nn.Module = resnet1d.resnet34_encoder(num_class=11)
    # tea_classifier: nn.Module = resnet1d.resnet34_decoder(num_class=11)
    # weight_path: str = "./weights/resnet34-baseline.pth"
