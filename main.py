...
if __name__ == "__main__":
    ...
    # teacher
    teacher_model: nn.Module = petcgdnn.PETCGDNN(num_classes=11)
    ...
    optimizer: optim.Optimizer = optim.Adam(params=student_encoder.parameters(), lr=1e-3)
    ...
    train.train_and_evaluate_kd(model, teacher_model, optimizer, train_dataloader, valid_dataloader,
